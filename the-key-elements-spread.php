    ...
    <div class= "container">
      <div class= "row">
        <div class= "col-xs-8 centered">
          <div class="heading">
            ...
            <p> <b> Live Link: </b> <a href="http://www.thekeyelements.online"> www.thekeyelements.online </a> </p>
      ...
      <div class= "row">
       ...
       <div class= "col-xs-8 centered">
        ...
        <div class= "col-xs-8 centered">
          <img class= "portfoliopicture" src="images/portfolio-spreads/ke-spread2.png" title= "The Key Elements Spread2" alt= "thekeyelements2">
        </div>
        <div class= "col-xs-8 centered">
        ...
        <div class= "col-xs-8 centered videoborder">
          <video img-responsive autoplay loop>
            <source src="images/animations/ke-desktop.mp4" type="video/mp4">
          </video>
        </div>
        <div class= "col-xs-8 centered">
          <img class= "portfoliopicture" src="images/portfolio-spreads/ke-spread3.png" title= "The Key Elements Spread3" alt= "thekeyelements3">
        </div>
        <div class= "col-xs-8 centered videoborder">
          <video img-responsive autoplay loop>
        ...
        <div class= "col-xs-8 centered videoborder">
          <video img-responsive autoplay loop>
            <source src="images/animations/ke-footer.mp4" type="video/mp4">
          </video>
        </div>
      </div> 
    </div> 
