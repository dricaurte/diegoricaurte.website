...
<body>
  ...
  <section class="portfolioitem firstSec section">
    <div class= "container">
      ...
      <div class= "row">
        <div class= "col-xs-8 centered">
          <img class= "portfoliopicture" src="images/portfolio-spreads/wake-spread1.png" title= "Wake Will Spread1" alt= "wakewill1">
        </div>
        <div class= "col-xs-8 centered">
          <h3 class="portfoliotitle2"> Objective </h3>
          <p class="portfolioitemtext"> The goal of Wake Will was to give rise to a groundswell of support from a devoted community of Wake Foresters, and to lay the foundation for the pursuit of something even greater. With this in mind, it was my objective to create interactive stations that would engage and captivate guests, sending a message to the target audience of the Wake Forest Alumni population.</p>
        </div>
        <div class= "col-xs-8 centered">
          <img class= "portfoliopicture" src="images/portfolio-spreads/wake-spread2.png" title= "Wake Will Spread2" alt= "wakewill2">
        </div>
        <div class= "col-xs-8 centered">
        ...
        <div class= "col-xs-8 centered">
          ...
          <p class="portfolioitemtext"> Designing to such a well established brand was certainly intimidating, given that this was one of my very first major design assignments. The experience ended up being a very positive one, and an excellent introduction to the core tenants in a well rounded and thoughtful design process.</p>
        </div>
        <div class= "col-xs-8 centered">
          <img class= "portfoliopicture" src="images/portfolio-spreads/wake-spread5.png" title= "Wake Will Spread4" alt= "wakewill5">
        </div>
      </div> 
    </div> 
  </section>
